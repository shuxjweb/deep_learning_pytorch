...
def MultiBoxPrior(feature_map, sizes=[0.75, 0.5, 0.25], ratios=[1, 2, 0.5]):
    ...
    shift_x, shift_y = np.meshgrid(shifts_x, shifts_y)  # [256, 128], [256, 128]

    shift_x = shift_x.reshape(-1)  # [32768,]
    shift_y = shift_y.reshape(-1)  # [32768,]

    shifts = np.stack((shift_x, shift_y, shift_x, shift_y), axis=1)  # [32768, 4]
    anchors = shifts.reshape((-1, 1, 4)) + base_anchors.reshape((1, -1, 4))  # [32768, 5, 4]
...
boxes = Y.reshape((h, w, 5, 4))         # [561, 728, 5, 4]
