...
content_img = Image.open('input/NeuralStyle5603/rainier.jpg')
plt.imshow(content_img)

style_img = Image.open('input/NeuralStyle5603/autumn_oak.jpg')
...
pretrained_net.load_state_dict(torch.load('input/vgg193427/vgg19-dcbb9e9d.pth'))
